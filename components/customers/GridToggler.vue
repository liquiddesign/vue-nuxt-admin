<template>
  <td colspan="10" class="p-0" style="background-color: white !important;">
    <div class="px-4 py-2 bg-white" style="border: 10px solid #f8f8f8;">
      <div class="row">
        <div class="col-lg-6">
          <table class="mb-2 table table-sm">
            <tbody>
              ...
              <tr>
                ...
                <td />
                <td />
                <td><button class="btn btn-xs btn-outline-success"><i class="fa fa-plus" /></button></td>
              </tr>
            </tbody>
          </table>
        </div>
              ...
              <li class="list-group-item pt-0">
                <div class="widget-content p-0">
                  <div class="widget-content-outer">
                    <div class="widget-content-wrapper">
                      <div class="widget-content-left">
                        <div class="widget-heading">Objednávka: <a href="">E2324324 <i class="fa fa-external-link" /></a></div>
