<template>
  <BaseForm ref="form" :url="url" :lang="lang" :data="data" :slug="slug" :rules="rules" :loading="loading" @success="$emit('success', goBack ? null : $event.result); goBack = false">
    ...
    <BaseFormRowInfo>Pokud nastavíte u productu doručení na automatické a zvolíte časový práh, tak se bude zobrazovat popisek před a po v závislosti na skutečném čase.</BaseFormRowInfo>
